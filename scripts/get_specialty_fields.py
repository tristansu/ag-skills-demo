...
def download_csb():
    ...
    result = subprocess.run(
        ["curl", "-L", "-o", CSB_ZIP, CSB_URL, "--max-time", "3600"],
        capture_output=True,
        text=True
    )
...
def main():
    ...
    print(f"  74 = Horticulture (includes grapes)")
    print(f"  75 = Berries")
    print(f"  204 = Christmas Trees")
    print(f"  36 = Alfalfa")
    print(f"  37 = Other Hay")
    print(f"  176 = Grassland/Herbaceous")
    print(f"  59 = Grass/Pasture")
    print(f"  38 = Small Grains")
    print(f"  24 = Winter Wheat")
    print(f"  27 = Spring Wheat")
    print()
