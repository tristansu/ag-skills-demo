...
Includes tabbed charts in popup showing monthly temperature and rainfall averages.

Input:  data/assignment-02/fields_complete.geojson
Output: docs/assignment-02/field_map_2.html

Features:
- Satellite basemap (ESRI World Imagery)
- Fields colored by crop type
- Popup with field details + monthly weather charts (tabbed)
- Crop legend
"""
...
def create_map():
    ...
    output_path = Path("docs/assignment-02/field_map_2.html")
